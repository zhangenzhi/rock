    ...
    def _plan_new_arc(self):
        ...
        try:
            ...
            arc = {
                ...
                "movie_plan": plan_data.get("overall_setting", {}), # movie_plan现在只存储整体设定
                "scenes": scenes
            }
