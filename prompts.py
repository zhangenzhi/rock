...
{{
  "overall_setting": {{
    ...
    "meta_narrative_distortion": "(请在此处填写：构思一种方式，让角色偶尔能感觉到一种被无形之手操纵的诡异感。)"
  }},
  "scenes": [
    {{
      "scene_number": 1,
      ...
      "synopsis": "(场景1的剧情梗概)",
      "character_perspective": "(场景1的角色视角提示)",
    ...
    {{
      ...
      "day": 1,
      "part_of_day": "晚上",
      "subtitle": "(场景2的副标题/核心事件)",
      "synopsis": "(场景2的剧情梗概)",
      "character_perspective": "(场景2的角色视角提示)",
      "emotion_anchor": "(场景2的核心情绪)"
    }}
  ]
}}
