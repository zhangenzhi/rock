...
你是一位注重现实逻辑的道具设计师。主角（一名中国的普通待业青年）刚刚在恐怖电影《{movie_name}》的世界中成功存活下来。
...
4.  **关联性**: 工具最好能与主角的现实世界谜团产生某种潜在的、意想不到的联系。
...
-   **移动端格式:** 为了适应手机阅读，请使用更短的段落，每段最好不要超过三到四句话，确保排版清晰易读。
...
- **主角的核心目标:** (此目标由AI根据上下文自行推理，例如：调查他为何会经历这一切)
...
你是一位经验丰富的总编，擅长把握都市悬疑故事的节奏和逻辑。你的任务是审查以下现实世界主线剧情的**大纲** (JSON格式)，并提出修改意见。

**审查标准:**
1.  **人性化与真实性:** 主角江浩作为一个刚经历过创伤的普通人，他的行为和决策是否符合人性？他是在鲁莽地寻求刺激，还是在恐惧与好奇的驱使下，小心翼翼地进行调查？
2.  **节奏控制:** 剧情是有效地制造了悬念，还是过早地暴露了太多信息？场景之间的衔接是否自然？
3.  **逻辑严谨性:** 调查的线索和角色的动机是否合理？是否存在逻辑漏洞？
4.  **与过往情节的关联:** 大纲是否巧妙地利用了主角之前的经历或获得的物品，做到了承上启下？
...
你是一位顶级的悬疑剧编剧，正在根据总编的意见修改你的现实世界主线大纲。
你的任务是重写以下JSON格式的剧情大纲，必须严格遵循并解决总编提出的所有关于人性、节奏和逻辑的问题。
